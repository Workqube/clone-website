    ...
    <section className="bg-navy-900 text-white py-8 md:py-12 relative overflow-hidden">
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          {/* First Image */}
          <div className="w-full lg:w-1/4 flex justify-center lg:justify-start z-10 mb-6 lg:mb-0">
            <Image
              src={HeaderImage1}
          ...
          <div className="w-full lg:w-1/2 z-10 text-center lg:text-left">
            ...
            <div className="flex justify-center  w-full">
              <Link
                href="/shop"
                className="bg-orange-600 hover:bg-orange-700 w-full text-white font-bold py-2 px-6 rounded-md text-lg md:text-2xl text-center inline-block transition duration-200"
              >
                Shop Now
              </Link>
            </div>
          ...
          {/* Second Image */}
          <div className="w-full lg:w-1/4 flex justify-center lg:justify-end z-10 mt-6 lg:mt-0">
            <Image
              src={HeaderImage2}
              alt="Microsoft Office Products"
              width={325}
